    ...
    if(data.length>0){
      return data.map((item)=>{
       return(
        ...
        <div className="card"  style={{width:'17rem', height:'400px',display:'inline-block',margin:'50px 60px 0 15px',borderRadius:'20px',border:'1px solid grey' }}>    
        <div className="card-header" style={{padding:'0'}}>
          <img src={item.image?item.image:"https://d33wubrfki0l68.cloudfront.net/9f04f9d75a9d338fe257f87ddc7d061066a1b975/34662/img/drone-pilot-training/banner.svg"} alt={item.meal_type} style={{width:'100%',height:'170px',borderRadius:'20px 20px 0 0', border:'1px solid transparent'}}/>
        </div>
        <div className="card-body" style={{textAlign:'center'}}>
           ...
           <h6><span className="discount">{item.discount?item.discount:"₹32000"} </span>  ₹34000</h6>
            <Link className="btn btn-primary" to={`/details/${item.id}`} style={{justifyContent:'center', textAlign:'center'}}>Details</Link>
        </div>
...
return(
  ...
  <div  id="navbutton">
         <ul className="navbar-nav toggle nav"  aria-label="Default select example">
          <li className="nav-item " onClick={this.handleColor2} >
...
{/* //////////////////body content////////////////// */}
    <div className="col-md-9" id='content' style={{display:'inline-block',marginTop:'80px'}}>
        ...
        <button className="btn btn-primary" style={{marginLeft:'10px', marginBottom:'7px'}} onClick={this.searchBar}><svg xmlns="http://www.w3.org/2000/svg" height="1em" style={{fill:'white'}} viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>
                    ...
                    <div className="col-md-3" style={{display:'inline-block', marginTop:'20px'}}>
                        <div className="filter" id="filters">
                            <h4 style={{textAlign:"center",marginTop:'5px',marginBottom:'15px'}}>Filter</h4>
                          <hr style={{marginLeft:'20%', marginRight:'20%',border:'1px solid'}}/>
                         <form>
                            <h6 style={{textAlign:'center'}}>Course Type</h6>
                         <div className="form-check form-switch">
                         <div className="cost-filter">
                         <input className="form-check-input" type="radio" name='check1' value='1' onClick={this.handleClick2}    />
                         <label  className="form-check-label">Small</label>
                         </div>
                         <div className="cost-filter">
                         <input className="form-check-input" type="radio" name='check1' value='2' onClick={this.handleClick2}    />
                         <label  className="form-check-label">Medium</label>
                         </div>
                         <div className="cost-filter">
                         <input className="form-check-input" type="radio" name='check1' value='3' onClick={this.handleClick2}    />
                         <label  className="form-check-label">Vlos</label>
                         </div>
                         <div className="cost-filter">
                         <input className="form-check-input" type="radio" name='check1' value='4' onClick={this.handleClick2}    />
                         <label  className="form-check-label">Bvlso</label>
                         </div>
                         </div>
                         </form>
                        </div>
